...
import { useLikePost } from "@/app/features/posts/api/likePost";
...
const ButtonLike = ({id, isLike}: ButtonLikeProps) => {
   const { mutate: likePost, isPending } = useLikePost();

  return (
    <button onClick={() => likePost({ id: String(id), isLike })} disabled={isPending}> 
